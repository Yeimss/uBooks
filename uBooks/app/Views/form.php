        ...
        <section class="container">
            <div class="row d-flex justify-content-center">
                <div class="col-12 col-md-5 bordecinho p-4">
                    <form method="POST" action="<?=site_url('/from/insertar')?>">
                        <div class="mb-3 mt-4">
                            <label for="nombre_usu" class="form-label d-flex justify-content-center">Nombre:</label>
                            <input type="text" class="form-control" name="nombre_usu">
                        </div>
                        <div class="mb-3 mt-4">
                            <label for="nombre_libro" class="form-label d-flex justify-content-center">Nombre del libro:</label>
                            <input type="text" class="form-control" name="nombre_libro">
                        </div>
                        <div class="mb-3 mt-4">
                            <label for="autor" class="form-label d-flex justify-content-center">Autor del libro:</label>
                            <input type="text" class="form-control" name="autor">
                        </div>
                        <div class="mb-3 mt-4">
                            <label for="genero_libro" class="form-label d-flex justify-content-center">Género:</label>
                            <input type="text" class="form-control" name="genero_libro">
                        </div>
                        <div class="mb-3 mt-4">
                            <label for="link" class="form-label d-flex justify-content-center">Link del libro:</label>
